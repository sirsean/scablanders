import { h as commonjsGlobal, g as getDefaultExportFromCjs, j as arrayify, B as BigNumber, L as Logger, k as concat, l as hexlify, m as isBytesLike, o as _base36To16, s as stripZeros, p as hexDataSlice, q as isHexString, r as hexConcat, u as hexZeroPad, w as require$$0, x as BN, y as splitSignature, z as hexDataLength, F as hexValue, E as EthersNetwork, D as DEFAULT_ALCHEMY_API_KEY, C as CustomNetworks, G as DEFAULT_NETWORK, N as Network, H as getAlchemyHttpUrl, I as getAlchemyWsUrl, V as VERSION, J as IS_BROWSER, _ as __awaiter$1$1, K as logWarn, M as deepCopy$1 } from "../worker.js";
var sha3$1 = { exports: {} };
/**
  ...
  if (typeof connection === "string") {
    ...
    if (connection.user != null && connection.password != null) {
      if (url.substring(0, 6) !== "https:" && connection.allowInsecureAuthentication !== true) {
        logger$3.throwError("basic authentication requires a secure https url", Logger.errors.INVALID_ARGUMENT, { argument: "url", url, user: connection.user, password: "[REDACTED]" });
      }
...
class BaseProvider extends Provider {
  ...
  _wrapTransaction(tx, hash2, startBlock) {
    ...
    if (hash2 != null && tx.hash !== hash2) {
      logger$1.throwError("Transaction hash mismatch from Provider.sendTransaction.", Logger.errors.UNKNOWN_ERROR, { expectedHash: tx.hash, returnedHash: hash2 });
    }
...
const alchemyProvider0b2e9f09 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AlchemyProvider
