/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8af1515b69eca6274abca5db704b5d1)
// Runtime types generated with workerd@1.20250712.0 2025-08-16 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AUTH_KV: KVNamespace;
		KV: KVNamespace;
		ALCHEMY_API_KEY: string;
		MY_DURABLE_OBJECT: DurableObjectNamespace<import("./server/worker").MyDurableObject>;
		WORLD_DO: DurableObjectNamespace<import("./server/worker").WorldDO>;
		PLAYER_DO: DurableObjectNamespace<import("./server/worker").PlayerDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALCHEMY_API_KEY">> {}
}
